...
CAROUSEL_UPLOADS_FOLDER = getattr(settings, "CAROUSEL_UPLOADS_FOLDER", "uploads/")
BOOTSTRAP_CAROUSEL_IMGSIZE = getattr(settings, "BOOTSTRAP_CAROUSEL_IMGSIZE", (800, 600))
BOOTSTRAP_CAROUSEL_FILE_EXTENSION = getattr(settings, "BOOTSTRAP_CAROUSEL_FILE_EXTENSION", 'jpeg')

# Zoom choices
CAROUSEL_ZOOM_IN = 'in'
CAROUSEL_ZOOM_OUT = 'out'
CAROUSEL_ZOOM_NO = 'no'

CAROUSEL_ZOOM_IN_LABEL = _('Zoom In')
CAROUSEL_ZOOM_OUT_LABEL = _('Zoom Out')
CAROUSEL_ZOOM_NO_LABEL = _('No Zoom')

CAROUSEL_ZOOM_CHOICES = getattr(
    settings,
    'CAROUSEL_ZOOM_CHOICES',
    ((CAROUSEL_ZOOM_IN, CAROUSEL_ZOOM_IN_LABEL),
     (CAROUSEL_ZOOM_OUT, CAROUSEL_ZOOM_OUT_LABEL),
     (CAROUSEL_ZOOM_NO, CAROUSEL_ZOOM_NO_LABEL))
)

# Target choices
CAROUSEL_OPEN_IN_NEW_TAB = 'new'
CAROUSEL_OPEN_IN_CURRENT_TAB = 'current'

CAROUSEL_OPEN_IN_NEW_TAB_LABEL = _('Open in new tab')
CAROUSEL_OPEN_IN_CURRENT_TAB_LABEL = _('Open in current tab')

CAROUSEL_OPEN_TAB_CHOICES = getattr(
    settings,
    'CAROUSEL_OPEN_TAB_CHOICES',
    ((CAROUSEL_OPEN_IN_NEW_TAB, CAROUSEL_OPEN_IN_NEW_TAB_LABEL),
     (CAROUSEL_OPEN_IN_CURRENT_TAB, CAROUSEL_OPEN_IN_CURRENT_TAB_LABEL))
)
